...
public class MedicalHistoryConfig : IEntityTypeConfiguration<MedicalHistory>
{
    public void Configure(EntityTypeBuilder<MedicalHistory> builder)
    {
        ...
        builder
            ...
            .HasMaxLength(255);
        builder
            .HasMany(x => x.Diagnosis)
            .WithOne(x => x.MedicalHistory)
            .HasForeignKey(
                e => e.MedicalHistoryId);
...
public class DiseaseConfig : IEntityTypeConfiguration<Disease>
{
    ...
    {
        builder
            .ToTable("Disease", SchemaNames.Base);
        builder
            .Property(x => x.Name)
            .IsRequired()
            .HasMaxLength(50);
...
public class MedicalHistoryDiseaseConfig : IEntityTypeConfiguration<MedicalHistoryDisease>
{
    public void Configure(EntityTypeBuilder<MedicalHistoryDisease> builder)
    {
        builder.ToTable("MedicalHistoryDisease", SchemaNames.Base);
        builder
            .HasKey(md => new { md.MedicalHistoryId, md.DiseaseId });


        builder
            .HasOne(mhd => mhd.MedicalHistory)
            .WithMany(mh => mh.Diagnosis)
            .HasForeignKey(mhd => mhd.MedicalHistoryId);

        builder
            .HasOne(mhd => mhd.Disease)
            .WithMany(d => d.HistoryDiseases)
            .HasForeignKey(mhd => mhd.DiseaseId);
    }
}
